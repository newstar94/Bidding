import{n as a}from"./view_helpers-CdPIbaii.js";import{ct as h}from"./app-RPlYyKwL.js";function p(i,e,{mode:d="technical",inviteComparisonLabel:n="Ngày mời đối chiếu tài liệu",comparisonLabel:s="Ngày đối chiếu tài liệu"}={}){if(!i)return;const t=d==="technical",l=a(e?.id||""),o=a(e?.tenGoiThau||""),c=t?`
  ...
  `:"";i.innerHTML=h(`
    ...
    <select id="danhgiahsdt-goithau-select" class="bf-s-6aa34d7432"><option value="${l}" selected>${o}</option></select>
    ...
    <div id="danhgiahsdt-container" class="bf-s-6aa34d7432">
      ...
      <div id="danhgiahsdt-tabs-header" class="bf-s-6aa34d7432">
        <button type="button" id="tab-btn-hsdxt-kt" class="${t?"active":""}">KT</button>
        <button type="button" id="tab-btn-hsdxt-tc" class="${t?"":"active"}">TC</button>
      </div>
