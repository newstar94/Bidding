...
export function getWordSourceTableLabel(tableName) {
  return WORD_SOURCE_TABLE_LABELS[tableName] || tableName;
}

export function getWordColumnLabel(tableName, columnName) {
  return FIELD_METADATA_BY_TABLE[tableName]?.[columnName]?.label || columnName;
}
