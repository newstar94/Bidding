...
export function setupWordTemplatesEvents() {
  ...
  const MAPPING_COLUMNS = {
    ...
    "ke_hoach_lcnt": [
      ...
      { value: "so_to_trinh_du_toan", label: "Số tờ trình dự toán" },
      ...
      { value: "so_to_trinh_ke_hoach", label: "Số tờ trình kế hoạch LCNT" },
      { value: "so_to_trinh_du_toan_ke_hoach", label: "Số tờ trình dự toán và kế hoạch LCNT" },
    ...
    "hop_dong": [
      ...
      { value: "trang_thai_hop_dong", label: "Trạng thái hợp đồng" },
    ...
    "thong_tin_mo_thau": [
      ...
      { value: "gia_xep_hang", label: "Giá xếp hạng" },
      { value: "gia_de_nghi_trung_thau", label: "Giá đề nghị trúng thầu" },
      { value: "chap_thuan_gia_de_nghi_trung_thau_duoi_50", label: "Chấp thuận giá đề nghị trúng thầu dưới 50%" },
