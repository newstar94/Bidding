    ...
    const getColumnLabel = (tbl, col) => {
        ...
        const cols = {
            ...
            'goi_thau': {
                ...
                'phan_lo': 'Phân lô gói thầu (Có/Không)',
            ...
            'phan_lo': {
                ...
                'nha_thau_trung': 'Nhà thầu trúng thầu phân lô',
                'thoi_gian_thuc_hien': 'Thời gian thực hiện phân lô'
            },
            'tuy_chon_mua_them': {
