...
| Xung đột đồng thời | Hai người cùng sửa một bản ghi; sửa trong khi người khác xóa; hai thẻ cùng gửi mutation; mất mạng rồi kết nối lại | Không mất dữ liệu âm thầm; có cảnh báo xung đột; không gửi lặp vô hạn | Log hai phiên, dữ liệu cuối trong PostgreSQL |
...
| Tải đồng thời | Nhiều người đăng nhập, phân trang, đồng bộ, nhập Excel và xuất Word cùng lúc | Không tăng lỗi `5xx`, không cạn pool/lock PostgreSQL kéo dài, thời gian phản hồi nằm trong ngưỡng đã thống nhất |
