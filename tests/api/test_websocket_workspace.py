...
def test_sqlite_websocket_outbox_cleanup_uses_portable_cutoff(monkeypatch, tmp_path):
    database_path = tmp_path / "websocket-outbox.db"
    ...
    try:
        ...
        connection.executemany(
            """
            INSERT INTO websocket_events (event_type, created_at)
            VALUES ('broadcast', ?)
            """,
    ...
    remaining = websocket_module._load_broker_events(0)
