...
async def list_word_mappings_api(request):
    try:
        ...
        cursor.execute("SELECT COUNT(*) FROM cau_hinh_bien_word WHERE owner_id = ?", (org_name,))
        ...
        if count == 0:
            ...
            default_seeds_data = {
                'chu_dau_tu': [
                    ...
                    ('chuc_vu_nguoi_dung_dau', 'chuc_vu_nguoi_dung_dau', 'Chức vụ người đứng đầu'),
                    ('dai_dien_cdt', 'dai_dien_cdt', 'Đại diện CĐT'),
                    ('chuc_vu_dai_dien', 'chuc_vu_dai_dien', 'Chức vụ người đại diện'),
                    ('danh_xung', 'danh_xung_cdt', 'Danh xưng chủ đầu tư'),
                    ...
                    ('ma_ngan_hang', 'ma_ngan_hang_cdt', 'Mã ngân hàng chủ đầu tư')
                ],
                'ke_hoach_lcnt': [
                    ('ten_ke_hoach', 'ten_ke_hoach', 'Tên kế hoạch LCNT'),
                    ('ma_ke_hoach', 'ma_ke_hoach', 'Mã kế hoạch LCNT'),
                    ('so_quyet_dinh', 'so_quyet_dinh_kh', 'Số quyết định kế hoạch LCNT'),
                    ('ngay_quyet_dinh', 'ngay_quyet_dinh_kh', 'Ngày quyết định kế hoạch LCNT'),
                    ('tong_muc_dau_tu', 'tong_muc_dau_tu', 'Tổng mức đầu tư'),
                    ('loai_hinh_mua_sam', 'loai_hinh_mua_sam', 'Loại hình mua sắm'),
                    ('nguon_von', 'nguon_von', 'Nguồn vốn')
                ],
                'goi_thau': [
                    ('ma_goi_thau', 'ma_goi_thau', 'Mã gói thầu'),
                    ('ten_goi_thau', 'ten_goi_thau', 'Tên gói thầu'),
                    ('gia_goi_thau', 'gia_goi_thau', 'Giá gói thầu'),
                    ('hinh_thuc_lua_chon_nha_thau', 'hinh_thuc_lcnt', 'Hình thức lựa chọn nhà thầu'),
                    ('phuong_thuc_lua_chon_nha_thau', 'phuong_thuc_lcnt', 'Phương thức lựa chọn nhà thầu'),
                    ('loai_hop_dong', 'loai_hop_dong_gt', 'Loại hợp đồng gói thầu'),
                    ('phan_lo', 'phan_lo_gt', 'Phân lô gói thầu'),
                    ('thoi_gian_dang_tai', 'thoi_gian_dang_tai', 'Thời gian đăng tải'),
                    ('thoi_gian_dong_thau', 'thoi_gian_dong_thau', 'Thời gian đóng thầu'),
                    ('thoi_gian_mo_thau', 'thoi_gian_mo_thau', 'Thời gian mở thầu'),
                    ('so_quyet_dinh', 'so_quyet_dinh_du_toan', 'Số quyết định dự toán'),
                    ('ngay_quyet_dinh', 'ngay_quyet_dinh_du_toan', 'Ngày quyết định dự toán'),
                    ('so_quyet_dinh_ket_qua', 'so_quyet_dinh_ket_qua', 'Số quyết định kết quả LCNT'),
                    ('ngay_quyet_dinh_ket_qua', 'ngay_quyet_dinh_ket_qua', 'Ngày quyết định kết quả LCNT'),
                    ('thoi_gian_goi_thau', 'thoi_gian_goi_thau', 'Thời gian thực hiện gói thầu'),
                    ('thoi_gian_hop_dong', 'thoi_gian_hop_dong', 'Thời gian hợp đồng'),
                    ('gia_tri_dam_bao_du_thau', 'gia_tri_dam_bao_du_thau', 'Giá trị bảo đảm dự thầu'),
                    ('hieu_luc_hsdt', 'hieu_luc_hsdt', 'Hiệu lực HSDT (ngày)'),
                    ('hieu_luc_dam_bao_du_thau', 'hieu_luc_dam_bao_du_thau', 'Hiệu lực bảo đảm dự thầu'),
                    ('danh_gia_nang_luc', 'danh_gia_nang_luc', 'Đánh giá năng lực nhà thầu'),
                    ('ngay_yeu_cau_bao_gia', 'ngay_yeu_cau_bao_gia', 'Ngày yêu cầu báo giá'),
                    ('ngay_gui_bao_gia', 'ngay_gui_bao_gia', 'Ngày gửi báo giá'),
                    ('ngay_bao_cao_danh_gia_nha_thau', 'ngay_bao_cao_danh_gia_nha_thau', 'Ngày báo cáo đánh giá nhà thầu'),
                    ('ngay_moi_thuong_thao', 'ngay_moi_thuong_thao', 'Ngày mời thương thảo'),
                    ('ngay_thuong_thao', 'ngay_thuong_thao', 'Ngày thương thảo'),
                    ('ngay_trinh_ket_qua', 'ngay_trinh_ket_qua', 'Ngày trình kết quả'),
                    ('so_to_trinh_hsmt', 'so_to_trinh_hsmt', 'Số tờ trình phê duyệt HSMT'),
                    ('ngay_trinh_hsmt', 'ngay_trinh_hsmt', 'Ngày trình phê duyệt HSMT'),
                    ('yeu_cau_tham_dinh_hsmt', 'yeu_cau_tham_dinh_hsmt', 'Yêu cầu thẩm định HSMT'),
                ...
                'hop_dong': [
                    ...
                    ('thoi_gian_thuc_hien', 'thoi_gian_thuc_hien_hd', 'Thời gian thực hiện hợp đồng'),
                    ('trang_thai_ho_so', 'trang_thai_ho_so_hd', 'Trạng thái hồ sơ hợp đồng'),
                    ('phan_loai', 'phan_loai_hd', 'Phân loại hợp đồng'),
                    ('co_qd_chi_dinh', 'co_qd_chi_dinh_hd', 'Có quyết định chỉ định thầu'),
                ...
                'chuyen_gia': [
                    ...
                    ('chuc_vu', 'chuc_vu', 'Chức vụ chuyên gia trong tổ'),
                ...
                'thong_tin_mo_thau': [
                    ...
                    ('hieu_luc_hsdt', 'hieu_luc_hsdt_mt', 'Hiệu lực HSDT mở thầu'),
                ...
                'tai_khoan': [
                    ...
                    ('da_xac_minh', 'da_xac_minh_user', 'Đã xác minh tài khoản')
                ],
                'to_chuc': [
