...
SCHEMA_DINH_NGHIA = {
    ...
    "goi_dich_vu": {
        "columns": {
            ...
            "document_export_word": "INTEGER NOT NULL DEFAULT 1 CHECK(document_export_word IN (0,1))",
            "document_export_excel": "INTEGER NOT NULL DEFAULT 1 CHECK(document_export_excel IN (0,1))",
            "document_export_award_result_excel": "INTEGER NOT NULL DEFAULT 1 CHECK(document_export_award_result_excel IN (0,1))",
    ...
    "auth_sessions": {
        "columns": {
            ...
            "active_role_organization_id": "TEXT CHECK(active_role_organization_id IS NULL OR (active_role IS NOT NULL AND TRIM(active_role_organization_id) != ''))"
        },
        "foreign_keys": [
    ...
    "document_jobs": {
        "columns": {
            ...
            "filename": "TEXT",
            "content_type": "TEXT",
            "policy_json": "TEXT NOT NULL DEFAULT '' CHECK(length(policy_json) <= 65536)",
    ...
    "ke_hoach_lcnt": {
        "columns": {
            ...
            "thong_tin_khac": "TEXT",
            "can_cu_gia_goi_thau": "TEXT NOT NULL DEFAULT ''",
    ...
    "goi_thau_phan_lo": {
        "columns": {
            ...
            "goi_thau_id": "TEXT NOT NULL",
            "ma_phan_lo": "TEXT",
            "ma_phan_lo_normalized": "TEXT NOT NULL DEFAULT ''",
            "ten_phan_lo": "TEXT",
