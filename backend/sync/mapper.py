...
from backend.sync.child_projection import (
    format_award_child as _format_award_child,
    format_clarification_child as _format_clarification_child,
    format_ehsmt_adjustment_child as _format_ehsmt_adjustment_child,
    format_extension_child as _format_extension_child,
    format_lot_child as _format_lot_child,
...
from backend.sync import evaluation_persistence, payload_mapping
...
# Compatibility aliases: keep the historical mapper interface while the
# evaluation persistence implementation lives at its dedicated seam.
_save_evaluation_rounds = evaluation_persistence.save_evaluation_rounds
_save_bid_evaluation_result = evaluation_persistence.save_bid_evaluation_result
